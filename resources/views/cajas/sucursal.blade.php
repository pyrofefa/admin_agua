		...
		<div class="row">
			<div class="col-md-12">
             ...
             <td style="width: 400px;">
                  <a href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].':8080/turnomatic/public/cajas/'.$c->id; ?>" class="btn btn-info">Ver</a>
						      <a href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].':8080/turnomatic/public/cajas/'.$c->id.'/edit' ?>" class="btn btn-warning">Editar</a>
