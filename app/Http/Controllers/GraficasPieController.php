...
class GraficasPieController extends Controller
{
    ...
    public function grafica_subasunto_fecha_sucursal($id, $fecha, $fecha_dos)
    {
        $tiket = DB::table('tikets')->selectRaw('subasunto as name, count(subasunto) as y, created_at')
            ->where('estado',1)
            ->whereRaw("DATE(created_at) BETWEEN '$fecha' AND '$fecha_dos'")
    ...
    public function grafica_subasunto_fecha_sucursalab($id, $fecha, $fecha_dos)
    {
        $tiket = DB::table('tikets')->selectRaw('subasunto as name, count(subasunto) as y, created_at')
            ->where('estado',2)
            ->whereRaw("DATE(created_at) BETWEEN '$fecha' AND '$fecha_dos'")
    ...
    public function grafica_tramites_fecha_sucursal($id, $fecha, $fecha_dos)
    {
        $tiket = DB::table('tikets')->selectRaw('asunto as name, count(asunto) as y, created_at')
            ->where('estado',1)
            ->Where('subasunto','=','Trámites')
    ...
    public function grafica_tramites_fecha_sucursal_ab($id, $fecha, $fecha_dos)
    {
        $tiket = DB::table('tikets')->selectRaw('asunto as name, count(asunto) as y, created_at')
            ->where('estado',2)
    ...
    public function grafica_aclaraciones_fecha_sucursal($id, $fecha, $fecha_dos)
    {
        $tiket = DB::table('tikets')->selectRaw('asunto as name, count(asunto) as y, created_at')
            ->where('estado',1)
            ->Where('subasunto','=','Aclaraciones y Otros')
    ...
    public function grafica_aclaraciones_fecha_sucursal_ab($id, $fecha, $fecha_dos)
    {
        $tiket = DB::table('tikets')->selectRaw('asunto as name, count(asunto) as y, created_at')
            ->where('estado',2)
            ->Where('subasunto','=','Aclaraciones y Otros')
    ...
    public function grafica_pagos_fecha_sucursal($id, $fecha, $fecha_dos)
    {
        $tiket = DB::table('tikets')->selectRaw('asunto as name, count(asunto) as y, created_at')
            ->where('estado',1)
            ->Where('subasunto','=','Pago')
    ...
    public function grafica_pagos_fecha_sucursal_abandonados($id, $fecha, $fecha_dos)
    {
        $tiket = DB::table('tikets')->selectRaw('asunto as name, count(asunto) as y, created_at')
            ->where('estado',2)
            ->Where('subasunto','=','Pago')
