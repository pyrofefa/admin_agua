...
Route::get('graficas/tramites/solicitud/{fecha}/{fecha_dos}','GraficaTramites@grafica_solicitud_fecha');
Route::get('graficas/tramites/baja/{fecha}/{fecha_dos}','GraficaTramites@grafica_baja_fecha');
...
Route::get('graficas/tramites/solicitud_tarifa_id/{id}/{fecha}/{fecha_dos}','GraficaTramites@grafica_solicitud_tarifa_id_fecha');
Route::get('graficas/tramites/baja_id/{id}/{fecha}/{fecha_dos}','GraficaTramites@grafica_baja_id_fecha');
...
Route::get('graficas/tramites/tarifasocial','GraficaTramites@grafica_tarifasocial');
Route::get('graficas/tramites/bajaporimpago','GraficaTramites@grafica_bajaporimpago');
...
Route::get('graficas/tramites/atencion_tarifasocial','GraficaTramites@promedio_atendido_tarifasocial');
Route::get('graficas/tramites/atencion_bajaporimpago','GraficaTramites@promedio_atendido_bajaporimpago');
...
Route::get('graficas/tramites/espera_tarifasocial','GraficaTramites@promedio_espera_tarifasocial');
Route::get('graficas/tramites/espera_bajaporimpago','GraficaTramites@promedio_espera_bajaporimpago');
...
Route::get('graficas/aclaraciones/alta_estimacion/{fecha}/{fecha_dos}','GraficaAclaraciones@grafica_alta_fecha');
Route::get('graficas/aclaraciones/propuestas/{fecha}/{fecha_dos}','GraficaAclaraciones@grafica_propuestas_fecha');
Route::get('graficas/aclaraciones/aviso/{fecha}/{fecha_dos}','GraficaAclaraciones@grafica_aviso_fecha');
...
Route::get('graficas/aclaraciones/alta_id/{id}/{fecha}/{fecha_dos}','GraficaAclaraciones@grafica_alta_id_fecha');
Route::get('graficas/aclaraciones/propuestas_id/{id}/{fecha}/{fecha_dos}','GraficaAclaraciones@grafica_propuestas_id_fecha');
Route::get('graficas/aclaraciones/aviso_id/{id}/{fecha}/{fecha_dos}','GraficaAclaraciones@grafica_aviso_id_fecha');
...
Route::get('graficas/aclaraciones/altaestimacion','GraficaAclaraciones@grafica_altaestimacion');
Route::get('graficas/aclaraciones/propuestas','GraficaAclaraciones@grafica_propuestas');
Route::get('graficas/aclaraciones/aviso','GraficaAclaraciones@grafica_aviso');
...
Route::get('graficas/aclaraciones/atencion_altaestimacion','GraficaAclaraciones@promedio_atendido_altaestimacion');
Route::get('graficas/aclaraciones/atencion_propuestas','GraficaAclaraciones@promedio_atendido_propuestas');
Route::get('graficas/aclaraciones/atencion_aviso','GraficaAclaraciones@promedio_atendido_aviso');
...
Route::get('graficas/aclaraciones/espera_altaestimacion','GraficaAclaraciones@promedio_espera_altaestimacion');
Route::get('graficas/aclaraciones/espera_propuestas','GraficaAclaraciones@promedio_espera_propuestas');
Route::get('graficas/aclaraciones/espera_aviso','GraficaAclaraciones@promedio_espera_aviso');
...
Route::get('graficas/pago/facturas/{fecha}/{fecha_dos}','GraficaPagos@grafica_pagofacturas_fecha');
...
Route::get('graficas/pago/facturas_id/{id}/{fecha}/{fecha_dos}','GraficaPagos@grafica_facturas_id_fecha');
...
Route::get('graficas/pago/facturas','GraficaPagos@grafica_facturas');
...
Route::get('graficas/pago/carta/{id}','GraficaPagos@grafica_pagocarta_id');
Route::get('graficas/pago/facturas/{id}','GraficaPagos@grafica_pagofacturas_id');
