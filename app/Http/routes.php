...
Route::get('home/excelfecha/{fecha}/{fecha_dos}','ExcelController@importar_fecha');
Route::get('home/sucursal/excel/{id}/{fecha}/{fecha_dos}','ExcelController@importar_sucursal_fecha');
...
Route::get('graficas/linealtramiteshorafechaid/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_subasunto_tramites_hora_fecha_id');
Route::get('graficas/linealaclaracioneshorafechaid/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_subasunto_aclaraciones_hora_fecha_id');
Route::get('graficas/linealpagohorafechaid/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_subasunto_pagos_hora_fecha_id');
Route::get('graficas/linealtramiteshorafechaida/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_subasunto_tramites_hora_fecha_id_a');
Route::get('graficas/linealaclaracioneshorafechaida/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_subasunto_aclaraciones_hora_fecha_id_a');
Route::get('graficas/linealpagohorafechaida/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_subasunto_pagos_hora_fecha_id_a');
Route::get('graficas/linealtiempoesperaglobalhorafecha/{fecha}/{fecha_dos}','GraficasLinealController@lineal_tiempo_espera_global_hora_fecha');
Route::get('graficas/linealtiempoesperatramiteshorafecha/{fecha}/{fecha_dos}','GraficasLinealController@lineal_tiempo_espera_tramites_hora_fecha');
Route::get('graficas/linealtiempoesperaaclaracioneshora/{fecha}/{fecha_dos}','GraficasLinealController@lineal_tiempo_espera_aclaraciones_hora_fecha');
Route::get('graficas/linealtiempoespagoshorafecha/{fecha}/{fecha_dos}','GraficasLinealController@lineal_tiempo_espera_pago_hora_fecha');
Route::get('graficas/linealtiempoesperaglobalhorafechaid/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_tiempo_espera_global_hora_fecha_id');
Route::get('graficas/linealtiempoesperatramiteshorafechaid/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_tiempo_espera_tramites_hora_fecha_id');
Route::get('graficas/linealtiempoesperaaclaracioneshoraid/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_tiempo_espera_acla_hora_fecha_id');
Route::get('graficas/linealtiempoespagoshorafechaid/{fecha}/{fecha_dos}/{id}','GraficasLinealController@lineal_tiempo_espera_pago_hora_fecha_id');
...
Route::get('graficas/linealtiempoatencionglobalhorafecha/{fecha}/{fecha_dos}','GraficasLinealController@promedio_tiempo_atencion_global_hora_fecha');
Route::get('graficas/linealtiempoatenciontramiteshorafecha/{fecha}/{fecha_dos}','GraficasLinealController@promedio_tiempo_atencion_tramites_hora_fecha');
Route::get('graficas/linealtiempoatencionaclaracioneshorafecha/{fecha}/{fecha_dos}','GraficasLinealController@promedio_tiempo_atencion_acla_hora_fecha');
Route::get('graficas/linealtiempoatencionpagohorafecha/{fecha}/{fecha_dos}','GraficasLinealController@promedio_tiempo_atencion_pago_hora_fecha');
...
Route::get('graficas/linealtiempodeatencionglobalhoraidfecha/{fecha}/{fecha_dos}/{id}','GraficasLinealController@promedio_tiempo_aten_global_hora_fecha_id');
Route::get('graficas/linealtiempodeatencionhoratridfecha/{fecha}/{fecha_dos}/{id}','GraficasLinealController@promedio_tiempo_aten_tramites_hora_fechaid');
Route::get('graficas/linealtiempodeatencionhoraaclaidfecha/{fecha}/{fecha_dos}/{id}','GraficasLinealController@promedio_tiempo_atencion_acla_hora_fechaid');
Route::get('graficas/linealtiempodeatencionhorapagosidfecha/{fecha}/{fecha_dos}/{id}','GraficasLinealController@promedio_tiempo_atencion_pago_hora_fechaid');
